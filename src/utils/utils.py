...
# Generates dictionary of neighbours for each client depending on the type of topology, including the client itself
def get_topology(num_clients, topology, max_random_neighbours):
  neighbour_dict = {}
