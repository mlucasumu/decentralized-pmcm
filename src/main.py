...
def get_args():
    ...
    parser.add_argument('--local_epochs', default=5, type=int)              # epochs per round
    parser.add_argument('--communication_rounds', default=10, type=int)     
    parser.add_argument('--client_nums', default=5, type=int)               # total number of clients
    parser.add_argument('--selected_client_nums', default=3, type=float)    # not necessary in decentralized pmcm
    parser.add_argument('--topology', default='ring', type=str)             # ring, fully, random
    parser.add_argument('--max_random_neighbours', default=4, type=int)     # only for random topologies
    # top parameters5
...
def main(args):
    ...
    # get neighbours for each client
